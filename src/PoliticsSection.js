...
class PoliticsSection extends Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        this.loadPoliticsData = this.loadPoliticsData.bind(this);
    ...
    loadPoliticsData() {
      ...
      fetch("https://wt-hw8-node-backend.appspot.com/politics", {
        method: 'GET',
        headers: {
